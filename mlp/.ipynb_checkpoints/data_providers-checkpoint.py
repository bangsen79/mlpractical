...
class EMNISTDataProvider(DataProvider):
    ...
    def label_smoothing(self, int_targets, alpha=0.1):
        ...
        """
        one_of_k_targets_smoothed = np.full((int_targets.shape[0],self.num_classes),(alpha/(self.num_classes-1)))
        one_of_k_targets_smoothed[np.arange(int_targets.shape[0]),int_targets] = 1-alpha
        return one_of_k_targets_smoothed
