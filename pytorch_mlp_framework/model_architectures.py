...
class ConvolutionalProcessingBlockWithBNRC(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation,reduction_factor = None):
        super(ConvolutionalProcessingBlockWithBNRC, self).__init__()
